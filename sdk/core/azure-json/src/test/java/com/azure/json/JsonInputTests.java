...
public class JsonInputTests {
    ...
    @Test
    public void arraysInArrays() throws IOException {

        JsonElement wtf = builder.build(
            "{\n" +
                "    \"ITEM1\":\n" +
                "    [11,\n" +
                "    [111, 999,[5555,[1],[5],[3],[2,20,[5,[909098405,[{\"TEST\":\"WOOHOO\"}],[111414141]]]]]],342,122\n" +
                "    ],\n" +
                "    \"KEY $\": \"WHAT?\"\n" +
                "}");
        assertEquals("{\"ITEM1\":[11,[111,999,[5555,[1],[5],[3],[2,20,[5,[909098405,[{\"TEST\":\"WOOHOO\"}],[111414141]]]]]],342,122],\"KEY $\":\"WHAT?\"}", wtf.toString());
    }
